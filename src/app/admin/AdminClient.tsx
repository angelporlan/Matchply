  ...
  return (
    <div className="relative text-text overflow-x-hidden font-sans">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 relative z-10">
        ...
        {/* Tab: IA Config */}
        {activeTab === 'ai' && (
          <div className="max-w-2xl mx-auto bg-surface p-6 rounded-[12px] border border-subtle shadow-sm animate-fadeIn">
            ...
            <form onSubmit={handleSaveSettings} className="space-y-6">
              ...
              <div className="pt-2">
                <button
                  type="submit"
                  className="w-full bg-text dark:bg-white hover:bg-text/90 dark:hover:bg-surface-muted border border-text dark:border-white text-canvas font-bold py-3.5 rounded-[8px] text-xs transition-all shadow-sm flex items-center justify-center gap-2 font-display"
                >
                  <Check className="w-4 h-4 stroke-[1.75]" />
            ...
            <div className="mt-8 border-t border-subtle pt-6">
              <button
                ...
                className="w-full flex items-center justify-between p-4 bg-canvas/30 rounded-[12px] border border-subtle hover:bg-surface-muted dark:hover:bg-white/5 transition-all text-text"
              >
                    ...
                    <div className="space-y-4 font-sans text-xs">
                      ...
                      {!openRouterKeyInfo.is_free_tier && (
                        <div className="mt-3.5 p-3.5 bg-action/5 dark:bg-action/10 border border-action/10 dark:border-action/20 rounded-[8px] text-[10px] text-text-muted dark:text-slate-300 leading-relaxed space-y-1.5 font-sans">
                          ...
                          <p>
                            Tu cuenta está marcada como de pago (has recargado saldo anteriormente). Tus límites diarios para modelos con terminación <code className="font-mono bg-white dark:bg-black/20 px-1 rounded font-bold">:free</code> son de <span className="font-bold text-success-text">1000 peticiones al día</span>.
                          </p>
                        </div>
                      )}
                    </div>
