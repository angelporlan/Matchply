  ...
  es: {
    ...
    subscription: {
      ...
      apiKey: {
        ...
        upsellDesc: '¿Quieres automatizar al 100% tu búsqueda de empleo? Actualiza a PRO para generar tu clave de API personal y conectar tu tablero Kanban de Matchply con agentes inteligentes de scraping y optimización automática como Career-Ops.',
        ...
        guideTitle: 'Guía de Integración Rápida con Career-Ops',
        guideDesc: 'Copia y pega la siguiente configuración directamente en tu archivo .env local en el repositorio de Career-Ops para vincular de forma segura e inmediata tu Kanban de Matchply:',
        ...
        confirmRevoke: '¿Estás seguro de que deseas revocar tu clave de API? Cualquier integración activa (como Career-Ops) dejará de funcionar inmediatamente.',
  ...
  en: {
    ...
    subscription: {
      ...
      apiKey: {
        ...
        upsellDesc: 'Do you want to automate 100% of your job search? Upgrade to PRO to generate your personal API key and connect your Matchply Kanban board with intelligent scraping and automatic optimization agents like Career-Ops.',
        ...
        guideTitle: 'Quick Integration Guide with Career-Ops',
        guideDesc: 'Copy and paste the following configuration directly into your local .env file in the Career-Ops repository to securely and immediately link your Matchply Kanban:',
        ...
        confirmRevoke: 'Are you sure you want to revoke your API Key? Any active integration (like Career-Ops) will stop working immediately.',
