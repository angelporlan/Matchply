# Servidor MCP y búsqueda de ofertas remotas — comportamiento deseado
...
**¿Qué herramientas quieres ofrecer, cómo se llaman y cuáles requieren confirmación humana?**

[ESCRIBE AQUÍ]

**¿Quieres búsqueda real en varios portales o mantener RSS más búsqueda del cliente?**

[ESCRIBE AQUÍ]

**¿Qué puede hacer un agente sin supervisión y cómo se limita su acceso?**
