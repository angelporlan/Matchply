# Páginas informativas, privacidad y soporte — comportamiento deseado
...
**¿Qué información y contactos definitivos deben figurar en estas páginas?**

[ESCRIBE AQUÍ]

**¿Cómo se solicita y ejecuta exportación, rectificación o eliminación de datos?**

[ESCRIBE AQUÍ]

**¿Qué consentimiento, retención y canal de soporte necesita cada integración?**
