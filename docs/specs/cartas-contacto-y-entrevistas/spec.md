# Carta de presentación, mensaje de contacto y preparación de entrevista — comportamiento deseado
...
**¿Qué tono, idioma, longitud y estructura quieres para cada documento?**

[ESCRIBE AQUÍ]

**¿Deben generarse juntos o por separado y aprobarse antes de guardar?**

[ESCRIBE AQUÍ]

**¿Quieres edición manual, versiones o envío real? Si hay envío, define destinatario y confirmación.**
