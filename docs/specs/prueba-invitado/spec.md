# Prueba sin cuenta y recuperación al registrarse — comportamiento deseado
...
**¿Cuántos CVs y días debe permitir la prueba? ¿Debe incluir IA y descarga?**

[ESCRIBE AQUÍ]

**¿Qué ocurrirá al registrarse si la prueba tiene más CVs que el plan gratuito?**

[ESCRIBE AQUÍ]

**¿Cuándo se deben eliminar datos caducados y cómo se avisa al visitante?**
