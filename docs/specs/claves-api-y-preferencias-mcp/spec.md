# Claves personales y configuración de integraciones — comportamiento deseado
...
**¿Cuántas claves, permisos y fechas de expiración quieres permitir?**

[ESCRIBE AQUÍ]

**¿Qué pasa con las claves al bajar de plan y quién puede revocarlas?**

[ESCRIBE AQUÍ]

**¿Quieres unificar preferencias MCP y perfil profesional para evitar campos duplicados?**
