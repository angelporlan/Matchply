# Editor, formato y comparación de cambios — comportamiento deseado
...
**¿Quieres edición por secciones, Markdown, ambos o uno de ellos?**

[ESCRIBE AQUÍ]

**¿Debe existir guardado manual, deshacer, versiones y aprobación de cambios IA?**

[ESCRIBE AQUÍ]

**¿Cómo quieres trabajar en móvil y qué ajustes de estilo deben permitirse?**
