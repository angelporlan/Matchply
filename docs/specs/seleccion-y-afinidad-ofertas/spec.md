# Selección de ofertas con IA y afinidad individual — comportamiento deseado
...
**¿Qué dimensiones, pesos, exclusiones y umbrales definen una buena oferta?**

[ESCRIBE AQUÍ]

**¿Quieres una escala única y saber qué motor produjo cada puntuación?**

[ESCRIBE AQUÍ]

**¿Debe la previsualización guardar puntuaciones y qué confirmación hace falta para archivar o mover?**
