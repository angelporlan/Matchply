# Perfil profesional, preferencias y reglas de selección — comportamiento deseado
...
**¿Qué campos son necesarios, opcionales o privados y cuáles usa cada función IA?**

[ESCRIBE AQUÍ]

**¿Qué debe representar el porcentaje de perfil y cómo se calcula?**

[ESCRIBE AQUÍ]

**¿Quieres un único perfil, varios objetivos de carrera o perfiles separados por candidatura?**
