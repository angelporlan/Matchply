# Vinculación y captura de ofertas desde Chrome — comportamiento deseado
...
**¿La captura será manual, automática o elegible y qué debe contar como oferta ya guardada?**

[ESCRIBE AQUÍ]

**¿Capturar debe iniciar investigación y consumir cuota automáticamente o pedir confirmación?**

[ESCRIBE AQUÍ]

**¿Desconectar debe revocar también la sesión de servidor? ¿Qué datos se permite capturar?**
