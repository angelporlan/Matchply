# Registro, acceso, cierre de sesión y datos de cuenta — comportamiento deseado
...
**¿Qué métodos de acceso deben existir y qué requisitos tendrá la contraseña?**

[ESCRIBE AQUÍ]

**¿Quieres recuperación, verificación de correo, cambio de email o borrado de cuenta?**

[ESCRIBE AQUÍ]

**¿Qué datos puede editar la persona y qué debe ocurrir con una sesión ya abierta al cambiar sus permisos?**
