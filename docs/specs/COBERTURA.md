...
| [scripts/application-views.test.ts](<../../scripts/application-views.test.ts>) | [F12 Candidaturas, tablero de postulaciones y detalle de oferta](candidaturas-kanban/estado-actual.md) |
