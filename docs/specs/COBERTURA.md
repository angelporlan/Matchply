...
| `/dashboard/integrations` | [src/app/dashboard/integrations/page.tsx](<../../src/app/dashboard/integrations/page.tsx>) | [F19 Claves personales y configuración de integraciones](claves-api-y-preferencias-mcp/estado-actual.md) |
| `/dashboard/kanban/archived` | [src/app/dashboard/kanban/archived/page.tsx](<../../src/app/dashboard/kanban/archived/page.tsx>) | [F13 Archivo, restauración y borrado de candidaturas](archivo-candidaturas/estado-actual.md) |
| `/dashboard/kanban/offer/[id]` | [src/app/dashboard/kanban/offer/[id]/page.tsx](<../../src/app/dashboard/kanban/offer/[id]/page.tsx>) | [F12 Candidaturas, Kanban y detalle de oferta](candidaturas-kanban/estado-actual.md) |
| `/dashboard/kanban` | [src/app/dashboard/kanban/page.tsx](<../../src/app/dashboard/kanban/page.tsx>) | [F12 Candidaturas, Kanban y detalle de oferta](candidaturas-kanban/estado-actual.md) |
...
| `/docs/api` | [src/app/docs/api/page.tsx](<../../src/app/docs/api/page.tsx>) | [F20 API externa: sincronización, perfil, evaluación y CV](api-externa/estado-actual.md) |
...
Se enumeran los métodos exportados explícitamente; los métodos implícitos del framework no se cuentan. Las rutas antiguas MCP también se incluyen aunque devuelvan 410.
...
| `/api/external/applications/[id]/cv` | POST | [src/app/api/external/applications/[id]/cv/route.ts](<../../src/app/api/external/applications/[id]/cv/route.ts>) | [F20 API externa: sincronización, perfil, evaluación y CV](api-externa/estado-actual.md) |
| `/api/external/applications/[id]` | PATCH | [src/app/api/external/applications/[id]/route.ts](<../../src/app/api/external/applications/[id]/route.ts>) | [F20 API externa: sincronización, perfil, evaluación y CV](api-externa/estado-actual.md) |
| `/api/external/applications` | GET, POST | [src/app/api/external/applications/route.ts](<../../src/app/api/external/applications/route.ts>) | [F20 API externa: sincronización, perfil, evaluación y CV](api-externa/estado-actual.md) |
| `/api/external/evaluate` | POST | [src/app/api/external/evaluate/route.ts](<../../src/app/api/external/evaluate/route.ts>) | [F04 Planes, límites y permisos funcionales](planes-y-permisos/estado-actual.md) · [F20 API externa: sincronización, perfil, evaluación y CV](api-externa/estado-actual.md) |
| `/api/external/profile/base-cv` | GET, PUT | [src/app/api/external/profile/base-cv/route.ts](<../../src/app/api/external/profile/base-cv/route.ts>) | [F20 API externa: sincronización, perfil, evaluación y CV](api-externa/estado-actual.md) |
| `/api/external/profile` | GET, PUT | [src/app/api/external/profile/route.ts](<../../src/app/api/external/profile/route.ts>) | [F20 API externa: sincronización, perfil, evaluación y CV](api-externa/estado-actual.md) |
...
| `/api/mcp/message` | POST | [src/app/api/mcp/message/route.ts](<../../src/app/api/mcp/message/route.ts>) | [F21 Servidor MCP y búsqueda de ofertas remotas](servidor-mcp/estado-actual.md) |
| `/api/mcp` | DELETE, GET, OPTIONS, POST | [src/app/api/mcp/route.ts](<../../src/app/api/mcp/route.ts>) | [F21 Servidor MCP y búsqueda de ofertas remotas](servidor-mcp/estado-actual.md) |
| `/api/mcp/sse` | GET, POST | [src/app/api/mcp/sse/route.ts](<../../src/app/api/mcp/sse/route.ts>) | [F21 Servidor MCP y búsqueda de ofertas remotas](servidor-mcp/estado-actual.md) |
...
| `generateUserApiKey` | [src/app/dashboard/actions.ts](<../../src/app/dashboard/actions.ts>) (línea 234) | [F19 Claves personales y configuración de integraciones](claves-api-y-preferencias-mcp/estado-actual.md) |
| `revokeUserApiKey` | [src/app/dashboard/actions.ts](<../../src/app/dashboard/actions.ts>) (línea 279) | [F19 Claves personales y configuración de integraciones](claves-api-y-preferencias-mcp/estado-actual.md) |
...
| `updateUserMcpSettings` | [src/app/dashboard/actions.ts](<../../src/app/dashboard/actions.ts>) (línea 396) | [F19 Claves personales y configuración de integraciones](claves-api-y-preferencias-mcp/estado-actual.md) |
...
| `getOwnedJobOffer` | [src/app/dashboard/kanban/actions.ts](<../../src/app/dashboard/kanban/actions.ts>) (línea 48) | [F12 Candidaturas, Kanban y detalle de oferta](candidaturas-kanban/estado-actual.md) |
| `exportJobOffersReport` | [src/app/dashboard/kanban/actions.ts](<../../src/app/dashboard/kanban/actions.ts>) (línea 73) | [F15 Copia de informes y análisis de candidaturas con IA](informes-y-analisis-candidaturas/estado-actual.md) |
| `updateJobOfferStatus` | [src/app/dashboard/kanban/actions.ts](<../../src/app/dashboard/kanban/actions.ts>) (línea 241) | [F12 Candidaturas, Kanban y detalle de oferta](candidaturas-kanban/estado-actual.md) |
| `archiveJobOffer` | [src/app/dashboard/kanban/actions.ts](<../../src/app/dashboard/kanban/actions.ts>) (línea 284) | [F13 Archivo, restauración y borrado de candidaturas](archivo-candidaturas/estado-actual.md) |
| `restoreArchivedJobOffer` | [src/app/dashboard/kanban/actions.ts](<../../src/app/dashboard/kanban/actions.ts>) (línea 325) | [F13 Archivo, restauración y borrado de candidaturas](archivo-candidaturas/estado-actual.md) |
| `archiveMultipleJobOffers` | [src/app/dashboard/kanban/actions.ts](<../../src/app/dashboard/kanban/actions.ts>) (línea 362) | [F13 Archivo, restauración y borrado de candidaturas](archivo-candidaturas/estado-actual.md) |
| `updateJobOfferCv` | [src/app/dashboard/kanban/actions.ts](<../../src/app/dashboard/kanban/actions.ts>) (línea 417) | [F12 Candidaturas, Kanban y detalle de oferta](candidaturas-kanban/estado-actual.md) |
| `deleteJobOffer` | [src/app/dashboard/kanban/actions.ts](<../../src/app/dashboard/kanban/actions.ts>) (línea 451) | [F12 Candidaturas, Kanban y detalle de oferta](candidaturas-kanban/estado-actual.md) |
| `createJobOffer` | [src/app/dashboard/kanban/actions.ts](<../../src/app/dashboard/kanban/actions.ts>) (línea 487) | [F12 Candidaturas, Kanban y detalle de oferta](candidaturas-kanban/estado-actual.md) |
| `updateJobOfferDetails` | [src/app/dashboard/kanban/actions.ts](<../../src/app/dashboard/kanban/actions.ts>) (línea 531) | [F12 Candidaturas, Kanban y detalle de oferta](candidaturas-kanban/estado-actual.md) |
| `analyzeFailuresAction` | [src/app/dashboard/kanban/actions.ts](<../../src/app/dashboard/kanban/actions.ts>) (línea 587) | [F15 Copia de informes y análisis de candidaturas con IA](informes-y-analisis-candidaturas/estado-actual.md) |
| `curateOffersWithAiAction` | [src/app/dashboard/kanban/actions.ts](<../../src/app/dashboard/kanban/actions.ts>) (línea 626) | [F14 Selección de ofertas con IA y afinidad individual](seleccion-y-afinidad-ofertas/estado-actual.md) |
| `evaluateSingleOfferMatchAction` | [src/app/dashboard/kanban/actions.ts](<../../src/app/dashboard/kanban/actions.ts>) (línea 718) | [F14 Selección de ofertas con IA y afinidad individual](seleccion-y-afinidad-ofertas/estado-actual.md) |
| `applyCuratedOffersAction` | [src/app/dashboard/kanban/actions.ts](<../../src/app/dashboard/kanban/actions.ts>) (línea 776) | [F14 Selección de ofertas con IA y afinidad individual](seleccion-y-afinidad-ofertas/estado-actual.md) |
...
| [src/components/kanban](<../../src/components/kanban>) | [F12 Candidaturas, Kanban y detalle de oferta](candidaturas-kanban/estado-actual.md) |
...
| [src/components/subscription](<../../src/components/subscription>) | [F19 Claves personales y configuración de integraciones](claves-api-y-preferencias-mcp/estado-actual.md) |
...
| Script | Área |
| --- | --- |
| [scripts/ai-jobs.test.ts](<../../scripts/ai-jobs.test.ts>) | [F20 API externa: sincronización, perfil, evaluación y CV](api-externa/estado-actual.md) · [F21 Servidor MCP y búsqueda de ofertas remotas](servidor-mcp/estado-actual.md) · [F25 Trabajos IA persistentes, ejecución y reintentos](trabajos-ia-y-reintentos/estado-actual.md) |
...
| [scripts/api-keys.test.ts](<../../scripts/api-keys.test.ts>) | [F19 Claves personales y configuración de integraciones](claves-api-y-preferencias-mcp/estado-actual.md) |
| [scripts/application-match.test.ts](<../../scripts/application-match.test.ts>) | [F20 API externa: sincronización, perfil, evaluación y CV](api-externa/estado-actual.md) |
...
| [scripts/migrate-legacy-linkedin.ts](<../../scripts/migrate-legacy-linkedin.ts>) | [F18 Investigación profunda de ofertas y empresas](linkedin-research/estado-actual.md) |
...
| [scripts/test-external-api.ts](<../../scripts/test-external-api.ts>) | [F20 API externa: sincronización, perfil, evaluación y CV](api-externa/estado-actual.md) |
