# Archivo, restauración y borrado de candidaturas — comportamiento deseado
...
**¿Cuándo se archiva y cómo se distingue archivar, rechazar y eliminar?**

[ESCRIBE AQUÍ]

**¿Quieres papelera, recuperación temporal o limpieza automática?**
