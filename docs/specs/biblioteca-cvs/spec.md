# Biblioteca de CVs y panel principal — comportamiento deseado
...
**¿Qué significan para ti CV base, principal, copia y versión?**

[ESCRIBE AQUÍ]

**¿Quieres duplicar, archivar, recuperar borrados o mantener historial de cambios?**

[ESCRIBE AQUÍ]

**¿Qué métricas y filtros debe mostrar el panel y deben incluir los archivados?**
