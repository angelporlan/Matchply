...
- **ACT-F04-04:** IA avanzada, Kanban, claves personales, extensión LinkedIn e investigación profunda están definidos como funciones PRO.
...
- Algunas rutas tienen reglas distintas: evaluación externa con clave global no impone PRO; la acción de afinidad individual comprueba sesión y propiedad pero no llama a requireUserFeature.
