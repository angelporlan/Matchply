# API externa: sincronización, perfil, evaluación y CV — comportamiento deseado
...
**¿Qué integraciones podrán leer/escribir qué datos y debe mantenerse la clave global?**

[ESCRIBE AQUÍ]

**¿Cómo resolver duplicados, conflictos y datos omitidos en una sincronización?**

[ESCRIBE AQUÍ]

**¿Qué respuesta exacta esperas ante éxito parcial, operación pendiente y reintento?**
