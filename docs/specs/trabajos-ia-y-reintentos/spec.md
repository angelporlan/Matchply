# Trabajos IA persistentes, ejecución y reintentos — comportamiento deseado
...
**¿Qué operaciones deben continuar al cerrar navegador y cómo se recupera el resultado?**

[ESCRIBE AQUÍ]

**¿Cuántos trabajos simultáneos, intentos, minutos y costes máximos se permiten?**

[ESCRIBE AQUÍ]

**¿Quieres cancelar, reintentar manualmente y prevenir duplicados con una clave de operación?**
